...
class SwiGLUWithLimitFunction(torch.autograd.Function):
    ...
    def forward(ctx, x: torch.Tensor, limit: float):
        ...
        swiglu_with_limit_fwd_kernel[grid](  # pylint:disable=possibly-used-before-assignment
            x,
            y,
            num_rows,
            float(limit),
    ...
    def backward(ctx, dy: torch.Tensor):
        ...
        swiglu_with_limit_bwd_kernel[grid](  # pylint:disable=possibly-used-before-assignment
            x,
            dy,
            dx,
            num_rows,

...
class DeprecatedArgsFeature(MindSpeedFeature):
    ...
    def register_args(self, parser: ArgumentParser):
        ...
        group.add_argument('--rope-scaling-beta-fast', type=int, default=32, dest='deprecated_rope_scaling_beta_fast',
                           help='Yarn rope: rope beta fast'
                                'Note: this option is deprecated, please use --beta-fast instead!')
        group.add_argument('--rope-scaling-beta-slow', type=int, default=1, dest='deprecated_rope_scaling_beta_slow',

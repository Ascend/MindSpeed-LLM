...
MODEL_TYPE_HF_CHOICES = ['qwen3', 'qwen3-moe', 'deepseek3', 'geneva2', 'glm45-air', 'glm45', 'bailing_mini', 'qwen3-next', 'seed-oss', 'deepseek32', 'magistral', 'deepseek2-lite', 'phi3.5', 'mamba2']
...
class CheckpointFeature(MindSpeedFeature):
    ...
    def register_args(self, parser: ArgumentParser):
        ...
        group.add_argument('--model-type-hf', type=str, default=None,
                            choices=['qwen3', 'qwen3-moe', 'deepseek3', 'geneva2', 'glm45-air', 'glm45', 'bailing_mini', 'qwen3-next', 'seed-oss',

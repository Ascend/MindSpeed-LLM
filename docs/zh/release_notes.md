...
| ---------------- | ------------------ | ------------ | -----------  | ------------- | -------- | --------------------- | ------------------- |
| 26.0.0（商用）   | 26.0.0_core_r0.12.1  | core_v0.12.1  | 2.7.1       | 26.0.0        | 9.0.0  | Python3.10            | master              |
...
|--|--|--|--|
|26.0.0|CANN 9.0.0<br>CANN 8.5.0<br>CANN 8.3.RC1<br>CANN 8.2.RC1<br>CANN 8.1.RC1<br>CANN 8.0.0<br>|26.0.0|master|

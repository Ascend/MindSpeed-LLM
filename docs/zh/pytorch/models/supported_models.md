...
> [!NOTE]
> - 仓库支持Atlas A2 和Atlas A3 训练系列产品，可通过[硬件信息查询](https://www.hiascend.com/cann/download)获取。并且要求单NPU的HBM为64GB及以上，[安装驱动固件](../install_guide.md)后可通过npu-smi info查看单NPU的HBM容量。

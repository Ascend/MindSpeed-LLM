...
- 长序列并行：通过切分序列维度降低单卡计算量，支持Ascend Ring Attention、Ulysses等，详见[Ascend Ring Attention 长序列并行](https://gitcode.com/Ascend/MindSpeed/blob/26.1.0_core_r0.12.1/docs/zh/features/ring-attention-context-parallel.md)和[Ulysses 长序列并行](https://gitcode.com/Ascend/MindSpeed/blob/26.1.0_core_r0.12.1/docs/zh/features/ulysses-context-parallel.md)。

...
> [!NOTE]
>
> In the document tables, "Released" indicates the commercial version has been released, "✅" indicates support, and "❌" indicates no support.
...
<tbody>
  <tr>
    <td><a href="../training/finetune/mcore/single_sample_finetune.md">Single-Sample Fine-Tuning</a></td>
    <td>✅</td>
    <td>✅</td>
    <td>✅</td>
    <td>[Ascend]</td>

...
Yet another RoPE extensioN (YaRN) adjusts positional encoding through NTK-by-parts to improve accuracy after sequence expansion.

![Rotary position encoding frequency distribution diagram](../../figures/yarn/position_embedding.png)

![NTK-by-parts segmented scaling diagram](../../figures/yarn/ntk_by_parts.png)

...
For detailed algorithm principles, see [Megatron recomputation](https://arxiv.org/abs/2205.05198) and MindSpeed [activation function recomputation](https://gitcode.com/Ascend/MindSpeed/blob/master/docs/zh/features/activation-function-recompute.md).

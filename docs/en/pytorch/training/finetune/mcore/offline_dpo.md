...
![DPO vs RLHF Workflow Comparison](../../../figures/dpo/dpo_vs_rlhf.png)
...
- `--dpo-beta`
  ...
  Optional. Regularization parameter that balances the reward score and Kullback-Leibler (KL) divergence. Default: `0.1`.

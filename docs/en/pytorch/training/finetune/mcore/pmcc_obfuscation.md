...
1. Refer to the [MindSpeed LLM Installation](../../install_guide.md) to complete the environment setup.
...
8. Deobfuscate the model.
    ...
    ```shell
    --load-dir ./model_weights/qwen3_mcore/           # Weight load path. Enter the weight path saved during conversion

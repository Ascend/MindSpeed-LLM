...
如下所示是 MindSpeed LLM 最新发布的 26.1.0 版本多架构镜像 Tag，每个 Tag 均为 `x86_64` 与 `aarch64` 二合一镜像。历史版本所有 Tag 请参考 [Supported Tags](https://gitcode.com/Ascend/MindSpeed-LLM/blob/26.1.0/docker/supported_tags.md)。

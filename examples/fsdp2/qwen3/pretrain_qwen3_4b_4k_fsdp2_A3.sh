...
MODEL_PATH=${MODEL_PATH:-./model_from_hf/Qwen3-4B}
DATA_PATH=${DATA_PATH:-./dataset/my_dataset_text_document}
OUTPUT_DIR=${OUTPUT_DIR:-./output/qwen3_4b_fsdp2_A3}
...
torchrun ${DISTRIBUTED_ARGS} train_fsdp2.py \
    examples/fsdp2/qwen3/pretrain_qwen3_4b_4k_fsdp2_A3.yaml \
    ...
    "$@" \
    2>&1 | tee "logs/fsdp2_qwen3_4b_pretrain_A3_${TIMESTAMP}.log"

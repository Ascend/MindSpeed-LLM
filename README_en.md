...
MindSpeed-LLM/
 ...
 ├── pretrain_deepseek4.py     # DeepSeek4 pretraining workflow
...
The [Documentation Guide](./docs/en/docs_guide.md) provides the complete documentation usage guide for MindSpeed LLM and covers the following core topics:
...
- **Model list**: models supported by the PyTorch framework.
...
See the [release notes](docs/en/release_notes_llm.md) for the latest and historical versions of MindSpeed LLM, including the software compatibility table, version compatibility information, and release notes for the current version.

# Installation

---

- For detailed installation steps and environment configuration, see [MindSpeed LLM installation for PyTorch](./docs/en/pytorch/training/install_guide.md).
...
- [Quick start for the Megatron backend](./docs/en/pytorch/training/quick_start.md)
- [Quick start for the FSDP2 backend](./docs/en/pytorch/training/fsdp2_quick_start.md)
...
> [!NOTE]
>
> In the table, "Released" indicates that the commercial version has been released, "✅" indicates support, and "❌" indicates no support.
...
| --------------------- | ------------| ------------ | ------------ | ------------ | ---------------------- | ----------- |
| 26.1.0                | v26.1.0      | Regular release     | Maintenance         | 2026/6/30   | Expected to enter no-maintenance status starting 2026/12/30 |             |
| 26.0.0                | v26.0.0      | Regular release     | Maintenance         | 2026/3/30   | Expected to enter no-maintenance status starting 2026/9/30    |             |
| 2.3.0                 | v2.3.0       | Regular release     | EOL         | 2025/12/30   | End of life            | 2026/6/30   |
| 2.2.0                 | v2.2.0       | Regular release     | EOL         | 2025/9/30    | End of life            | 2026/3/30    |
...
---
See the [Ascend Meeting Center](https://meeting.ascend.osinfra.cn/) for the schedule of MindSpeed LLM TC and SIG meetings.
...
[MindSpeed LLM Security Statement](./docs/en/SECURITYNOTE.md)

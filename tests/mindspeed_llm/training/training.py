...
def num_floating_point_operations(args, batch_size):
    def calculate_layer_counts():
        """Calculate the number of attention and MLP layers."""
        if args.hybrid_override_pattern:
            ...
            return num_attn_layers, num_mlp_layers
    ...
    def hybrid_flops(batch_size, seq_len, hidden_size,
                     num_attn_layers, num_mlp_layers,
                     num_attn_heads=32,
    ...
    if args.is_hybrid_model:
        ...
        num_attn_layers, num_mlp_layers = calculate_layer_counts()

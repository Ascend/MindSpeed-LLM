...
from mindspeed_llm.tasks.checkpoint.convert_ckpt_geneva2 import Geneva2Converter
...
def get_args():
    ...
    parser.add_argument('--model-type-hf', type=str, default="qwen3",
                        choices=['qwen3', 'qwen3-moe', 'deepseek3', 'geneva2', 'glm45-air', 'glm45', 'bailing_mini', 'qwen3-next', 'seed-oss', 'deepseek32', 'magistral', 'deepseek2-lite', 'phi3.5', 'mamba2', 'longcat', 'glm5'],
...
def main():
    ...
    elif args.model_type_hf == 'geneva2':
        converter = Geneva2Converter(args)

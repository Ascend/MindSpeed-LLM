...
| 自研 | 不涉及       | mindspeed_llm/core/datasets/gpt_dataset.py:159, 219             | https://gitcode.com/Ascend/MindSpeed-LLM/wiki/%E4%BB%A3%E7%A0%81%E6%8F%90%E4%BA%A4%E8%A7%84%E8%8C%83 | 详情地址     |
...
| 场景                                  | 使用方法                                         | 端口 | 可能的风险       |
| ------------------------------------- | ------------------------------------------------ | ---------- | ---------- |
| 使用MindSpeed-LLM进行训练任务时，新增32个随机端口和1个master-port端口（该端口与torch_npu的master-port端口一致） | 使用PyTorch分布式训练拉起任一任务 | [1024,65520]内 | 网络配置错误可能引发端口冲突或连接问题，影响训练效率。     |
